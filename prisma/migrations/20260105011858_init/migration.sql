...
CREATE TABLE "user_instructors" (
    ...
    CONSTRAINT "user_instructors_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "user_instructors_user_id_instructor_id_key" ON "user_instructors"("user_id", "instructor_id");
...
-- AddForeignKey
ALTER TABLE "user_instructors" ADD CONSTRAINT "user_instructors_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_instructors" ADD CONSTRAINT "user_instructors_instructor_id_fkey" FOREIGN KEY ("instructor_id") REFERENCES "instructors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
